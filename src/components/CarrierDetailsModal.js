...
const CarrierDetailsModal = ({ isOpen, onClose, carrier }) => {
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-900">{carrier.totalShipments}</p>
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-500">Active Routes</label>
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-900">${carrier.totalRevenue.toLocaleString()}</p>
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-500">Average Rate</label>
                        <p className="mt-1 text-sm text-gray-900">${carrier.avgShipmentRate.toLocaleString()}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-900">{carrier.lastShipmentDate}</p>
                      </div>
                    </div>
                  </div>
