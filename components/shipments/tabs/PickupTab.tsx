...
export function LocationDetails({ isOpen, onToggle }: LocationDetailsProps) {
  return (
          ...
          <div className='space-y-4'>
            ...
            <div>
              ...
              <p className='text-sm text-blue-600'>
                This is an example of the requirements and notes. It would be
                read-only and pulled in from the &quot;Locations&quot; meta
                (need to capture info).
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='flex items-center space-x-2'>
          <div
            className={`w-4 h-4 rounded-full ${
              location.confirmed ? "bg-green-500" : "bg-gray-300"
            }`}
          ></div>
